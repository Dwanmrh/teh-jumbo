            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-4">
                <div>
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <span class="text-xs font-bold text-rose-600 bg-rose-50 px-2 py-1 rounded-md border border-rose-100 uppercase tracking-wider">Pengeluaran Baru</span>
                    </div>
                    <h1 class="text-2xl md:text-4xl font-black text-stone-800 tracking-tight">Catat Pengeluaran</h1>
                    <p class="text-stone-500 text-sm mt-1 max-w-lg leading-relaxed">Catat biaya operasional, belanja stok, gaji, atau pengeluaran lainnya.</p>
                </div>
            </div>
                            ...
                            <div class="space-y-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <div class="space-y-2"
                                        ...
                                        <label class="text-[11px] font-bold text-stone-400 uppercase tracking-wider ml-1">Kategori (Pilih / Ketik)</label>
                                        <div class="relative" @click.outside="open = false">
                                            ...
                                            <div x-show="open" x-transition.opacity.duration.200ms
                                                ...
                                                <div x-show="filteredOptions.length === 0 && search.length > 0" class="px-3 py-2.5 text-sm text-stone-400 italic flex items-center gap-2">
                                                    ...
                                                    <span>Buat kategori baru: "<span x-text="search" class="font-bold text-stone-600"></span>"</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="text" name="penerima" placeholder="Contoh: Toko Plastik Jaya, PLN, Budi..." required
                                ...
                                <div class="space-y-2">
                                    <label class="text-[11px] font-bold text-stone-400 uppercase tracking-wider ml-1">Bukti Foto / Struk</label>
                                    <div class="relative group cursor-pointer">
                                        ...
                                        <div class="border-2 border-dashed border-stone-300 rounded-2xl p-4 flex items-center gap-4 transition-all group-hover:border-rose-400 group-hover:bg-rose-50/50"
                                            ...
                                            <div class="flex items-center gap-4 w-full" x-show="!imageUrl">
                                                ...
                                                <div>
                                                    <p class="text-sm font-bold text-stone-600 group-hover:text-rose-600">Upload Bukti</p>
                                            ...
                                            <div class="flex items-center gap-4 w-full" x-show="imageUrl" style="display: none;">
                                                ...
                                                <button type="button" @click.prevent="removeImage" class="z-30 p-2 text-stone-400 hover:text-rose-500 transition-colors">
                    ...
                    <div class="lg:col-span-1">
                        <div class="sticky top-6 space-y-6">
                            ...
                            <div class="bg-gradient-to-br from-rose-500 to-red-700 rounded-[2rem] p-6 text-white shadow-xl shadow-rose-500/20 relative overflow-hidden">
                                ...
                                <div class="relative z-10">
                                    <span class="text-rose-100 text-xs font-bold uppercase tracking-widest">Total Pengeluaran</span>
                            ...
                            <div class="bg-rose-50 rounded-2xl p-4 border border-rose-100 flex gap-3">
                                ...
                                <p class="text-xs text-rose-600/80 leading-relaxed font-medium">Pastikan bukti pembayaran jelas jika nominal pengeluaran di atas Rp 100.000.</p>
                            </div>
